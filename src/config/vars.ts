...
// LTI information
export const LTI_SECRET_KEY = process.env.LTI_SECRET_KEY;
export const LTI_CLIENT_ID = process.env.LTI_CLIENT_ID;
export const CANVAS_HOST = process.env.CANVAS_HOST;
