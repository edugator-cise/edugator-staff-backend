...
const handler = (err: APIError | Error, _req: Request, res: Response) => {
  ...
  const statusCode = err instanceof APIError? err.status : httpStatus.INTERNAL_SERVER_ERROR
...
const converter = (err: APIError | Error, req: Request, res: Response, _next: NextFunction) => {
